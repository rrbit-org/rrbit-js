...
proto.flatten = function() {
	this.flatMap(function (x) { return x; });
};
...
proto.traverse = function(applic, of) {
	this.reduce(function (list, next) { return of(next).map(function (x) { return function (y) { return y.concat([x]); }; }).ap(list); }, applic(this.empty));
};
